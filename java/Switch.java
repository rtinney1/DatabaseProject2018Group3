...
public class Switch extends JComponent implements MouseListener{
    ...
    public Switch(){
        super();
        Switch.this.setSize(new Dimension(45, 30));
        Switch.this.setPreferredSize(new Dimension(45, 30));
        Switch.this.setMinimumSize(new Dimension(45, 30));
        Switch.this.setVisible(true);
        Switch.this.setCursor(new Cursor(Cursor.HAND_CURSOR));
        Switch.this.addMouseListener(Switch.this);  
        //colores iniciales
        Switch.this.setBackgroundColor(new Color(0 ,102 ,204));
        Switch.this.setButtonColor(new Color(180,180,180));
    }
